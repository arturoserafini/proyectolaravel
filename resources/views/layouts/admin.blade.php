                        ...
                        <div class="dropdown d-inline-block user-dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                ...
                                <form action="/salir" method="post">
                                    @csrf
                                    <button type="submit" class="dropdown-item text-danger" ><i class="ri-shut-down-line align-middle me-1 text-danger"></i> Salir</button>
                                </form>
                            </div>
                        </div>
                ...
                <div data-simplebar class="h-100">
                    ...
                    <div id="sidebar-menu">
                        ...
                        <ul class="metismenu list-unstyled" id="side-menu">
                            ...
                            <li class="menu-title">Pedidos</li>
                            ...
                            <li>
                                ...
                                <ul class="sub-menu" aria-expanded="false">
                                    ...
                                    <li><a href="{{ route('cliente.index') }}">Lista Clientes</a></li>
                                </ul>
                            </li>
                            ...
                            <li>
                                ...
                                <ul class="sub-menu" aria-expanded="false">
                                    <li><a href="{{ route('pedido.create') }}">Nuevo Pedido</a></li>
                                    <li><a href="{{ route('pedido.index') }}">Lista Pedidos</a></li>
                                </ul>
                            </li>
